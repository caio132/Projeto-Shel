...
function CRMA(){
INT=$(dialog --stdout --inputbox "Coloque a interface da rede (Ex. : eth0 eht1)"  0 0)
echo "#########################################################################" >> /etc/network/interfaces
echo "auto $INT" >> /etc/networkin/interfaces
...
BROAD=$(dialog --stdout --inputbox "Coloque o Broadcast da rede: " 0 0)
